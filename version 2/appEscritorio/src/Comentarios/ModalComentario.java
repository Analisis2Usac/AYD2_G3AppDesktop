 ...
 * @author Rojeru San
 */
public class ModalComentario extends javax.swing.JDialog {
     ...
     */
    public ModalComentario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
         ...
         if (this.nombre.getText().equals("") ) {
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                Comentarios.Sentencias s = new Comentarios.Sentencias();

                s.setIdComentario(Integer.parseInt(this.codigo.getText()));
                s.setComentario(this.nombre.getText());
            
                int opcion = Comentarios.Opciones.actualizar(s);
                if (opcion != 0) {
                    String fila = this.id.getText();
                    Comentarios.Opciones.listar("");
                    VComentario.seleccionaFila(fila);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalComentario.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalComentario dialog = new ModalComentario(new javax.swing.JFrame(), true);
