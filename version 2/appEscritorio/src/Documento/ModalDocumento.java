 ...
 * @author Rojeru San
 */
public class ModalDocumento extends javax.swing.JDialog {
     ...
     */
    public ModalDocumento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private int  seleccionEmpleado(){
        
        empleados.trabajador cat = (empleados.trabajador) tipo.getSelectedItem();
        
        return cat.getIdEmpeado();
    ...
    private void llenarCbx(){
          ...
          ArrayList<empleados.trabajador> list = empleados.Opciones.obtener();
          
        
        DefaultComboBoxModel value = new DefaultComboBoxModel();
        tipo.setModel(value);
        
        value.addElement(new empleados.trabajador(0,0,"vacio"));
        
        for(empleados.trabajador item : list){
            value.addElement(new empleados.trabajador(item.getIdEmpeado(),item.getIdEmpresa(),item.getEmail()));
        } 
    ...
    private void initComponents() {
        ...
        ruta = new app.bolivia.swing.JCTextField();
        ...
        ruta.setBorder(null);
        ruta.setForeground(new java.awt.Color(58, 159, 171));
        ruta.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ruta.setPlaceholder("NOMBRE");
        ruta.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                rutaKeyTyped(evt);
            }
        });
        jPanel4.add(ruta, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, 240, 30));
        ...
        jPanel4.add(nombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, 240, 30));
        ...
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 60, 60));
        ...
        jPanel4.add(tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, 230, 30));
...
//        }
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        int seleccion =  seleccionEmpleado();
        
      
            if (this.registrar.getText().equals("GUARDAR")) {
                
                Documento.Sentencias s = new Sentencias();

                s.setId_documento(Integer.parseInt(this.id.getText()));
                s.setDocumento(this.ruta.getText());
               
                if(seleccion == 0){
                    s.setId_empleado(variablesGlobales.variablesEstaticas.id_empleado);
                    
                }else {
                    s.setId_empleado(seleccion);
                    
                }
               
                int opcion = Documento.Opciones.actualizar(s);
                if (opcion != 0) {
                    String fila = this.id.getText();
                    Documento.Opciones.listar("");
                    VDocumento.seleccionaFila(fila);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalDocumento.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalDocumento dialog = new ModalDocumento(new javax.swing.JFrame(), true);
    ...
    public static app.bolivia.swing.JCTextField ruta;
