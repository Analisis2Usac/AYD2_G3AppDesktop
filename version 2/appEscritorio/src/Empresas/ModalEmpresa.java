...
public class ModalEmpresa extends javax.swing.JDialog {
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        if (this.nombre.getText().equals("") ) {
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                Empresas.Sentencias s = new Sentencias(); 
                
                System.out.println("este es el id de la empresa "+this.id.getText());
                s.setIdEmpresa(Integer.parseInt(this.id.getText()));
                s.setNit(Integer.parseInt(this.nit.getText()));
                ...
                if(seleccion == 0){
                s.setId_municipio(Empresas.vEmpresa.idmunicipio);
                }else{
                    s.setId_municipio(seleccion);
                }
                s.setEmail(this.email.getText());
                s.setPassword(this.password.getText());
               
                int opcion = Empresas.Opciones.actualizar(s);
                if (opcion != 0) {
                    String fila = this.id.getText();
                    Empresas.Opciones.listar("");
                    vEmpresa.seleccionaFila(fila);
                ...
                s.setLatitud(Double.parseDouble(this.latitud.getText()));
                s.setLongitud(Double.parseDouble(this.longitud.getText()));
                s.setId_municipio(seleccionMunicipio());
                s.setEmail(this.email.getText());
                s.setPassword(this.password.getText());
               
                int opcion = Empresas.Opciones.registrar(s);
                if (opcion != 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalEmpresa.class
