...
import alertas.principal.WarningAlertMuni;
...
public class vEmpresa extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "NIT", "NOMBRE", "DIRECCION", "TELEFONO", "ZONA", "LATITUD", "LONGITUD", "MUNICIPIO", "EMAIL", "PASSWORD"
            }
        ) {
    ...
    private void nuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevo1ActionPerformed
        ModalEmpresa mp = new ModalEmpresa(new JFrame(), true);
    ...
    private void modificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificar1ActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                mp.nit.setText(this.tabla.getValueAt(fila,1).toString());
                mp.nombre.setText(this.tabla.getValueAt(fila, 2).toString());
                mp.direccion.setText(this.tabla.getValueAt(fila, 3).toString());
                mp.telefono.setText(this.tabla.getValueAt(fila, 4).toString());
                mp.zona.setText(this.tabla.getValueAt(fila, 5).toString());
                mp.latitud.setText(this.tabla.getValueAt(fila, 6).toString());
                mp.longitud.setText(this.tabla.getValueAt(fila, 7).toString());
                idmunicipio = Integer.parseInt(this.tabla.getValueAt(fila, 8).toString());
                mp.email.setText(this.tabla.getValueAt(fila, 9).toString());
                mp.password.setText(this.tabla.getValueAt(fila, 10).toString());
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        Empresas.Opciones.listar(this.buscar.getText());
