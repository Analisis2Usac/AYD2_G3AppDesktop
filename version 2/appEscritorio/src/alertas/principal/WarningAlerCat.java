 ...
 * @author Rojeru San
 */
public class WarningAlerCat extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WarningAlerCat(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlerCat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlerCat dialog = new WarningAlerCat(new javax.swing.JFrame(), true);
