 ...
 * @author Rojeru San
 */
public class WarningAlertMuni extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WarningAlertMuni(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = municipios.Opciones.eliminar(Integer.parseInt(this.id.getText()));
        if (elimina != 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertMuni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertMuni dialog = new WarningAlertMuni(new javax.swing.JFrame(), true);
