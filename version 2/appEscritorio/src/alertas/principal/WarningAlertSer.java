 ...
 * @author Rojeru San
 */
public class WarningAlertSer extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WarningAlertSer(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = servicios.Opciones.eliminar(Integer.parseInt(this.id.getText()));
        if (elimina != 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertSer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertSer dialog = new WarningAlertSer(new javax.swing.JFrame(), true);
