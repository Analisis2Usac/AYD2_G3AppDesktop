...
public class ModalCategoria extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ruta.setPlaceholder("RUTA");
        ruta.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                rutaKeyTyped(evt);
            }
        });
        jPanel4.add(ruta, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 170, 240, 30));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/productos/campo-nombre.png"))); // NOI18N
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 160, -1, -1));

        panel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 420, 240));
        ...
        panel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 459, 90));

        getContentPane().add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 476, 470));
...
//        }
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        if (this.nombre.getText().equals("") ) {
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                s.setIdCategoria(Integer.parseInt(this.codigo.getText()));
                s.setNombre(this.nombre.getText());
                s.setRuta(this.ruta.getText());
            
                int opcion = categorias.Opciones.actualizar(s);
                if (opcion != 0) {
                    String fila = this.id.getText();
                    categorias.Opciones.listar("");
                    categoria.seleccionaFila(fila);
                ...
                int opcion = categorias.Opciones.registrar(s);
                if (opcion != 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalCategoria.class
