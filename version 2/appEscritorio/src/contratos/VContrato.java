 ...
 * @author Rojeru San
 */
public class VContrato extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "FECHA", "EMPRESA", "SERVICIO", "PAGO", "CORREO USUARIO"
            }
        ) {
    ...
    private void eliminar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminar1ActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                variablesGlobales.variablesEstaticas.deleteOption = "DContrato";
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        contratos.Opciones.listar(this.buscar.getText());
