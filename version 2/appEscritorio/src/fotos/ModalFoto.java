 ...
 * @author Rojeru San
 */
public class ModalFoto extends javax.swing.JDialog {
     ...
     */
    public ModalFoto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        }
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        int seleccion =  seleccionEmpleado();
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                fotos.Sentencias s = new Sentencias();

                s.setIdFoto(Integer.parseInt(this.id.getText()));
                ...
                int opcion = fotos.Opciones.actualizar(s);
                if (opcion != 0) {
                    String fila = this.id.getText();
                    fotos.Opciones.listar("");
                    VFoto.seleccionaFila(fila);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalFoto.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalFoto dialog = new ModalFoto(new javax.swing.JFrame(), true);
