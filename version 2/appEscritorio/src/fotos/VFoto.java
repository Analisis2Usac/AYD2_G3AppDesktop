 ...
 * @author Rojeru San
 */
public class VFoto extends javax.swing.JInternalFrame {
    ...
    private void modificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificar1ActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                ModalFoto mp = new ModalFoto(new JFrame(), true);
                mp.id.setText(this.tabla.getValueAt(fila, 0).toString());
                mp.ruta.setText(this.tabla.getValueAt(fila, 1).toString());
                variablesGlobales.variablesEstaticas.id_empleado = Integer.parseInt(tabla.getValueAt(fila, 2).toString());
    ...
    private void eliminar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminar1ActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                variablesGlobales.variablesEstaticas.deleteOption = "DFoto";
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        fotos.Opciones.listar(this.buscar.getText());
