 ...
 * @author Rojeru San
 */
public class ModalLServicio extends javax.swing.JDialog {
     ...
     */
    public ModalLServicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalLServicio.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalLServicio dialog = new ModalLServicio(new javax.swing.JFrame(), true);
