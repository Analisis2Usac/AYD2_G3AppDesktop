 ...
 * @author Rojeru San
 */
public class ModalServicio extends javax.swing.JDialog {
     ...
     */
    public ModalServicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private int  seleccionCategoria(){
        ...
        categorias.Listar cat = (categorias.Listar) tipo.getSelectedItem();
    ...
    private void llenarCbx(){
          ...
          ArrayList<categorias.Listar> list = categorias.Opciones.obtener();
          
        
        DefaultComboBoxModel value = new DefaultComboBoxModel();
        tipo.setModel(value);
        
        value.addElement(new categorias.Listar(0,"Ingresar Categoria","vacio"));
        
        for(categorias.Listar item : list){
            value.addElement(new categorias.Listar(item.getIdCategoria(),item.getNombre(),item.getRuta()));
        } 
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        if (this.nombre.getText().equals("") ) {
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                int opcion = servicios.Opciones.actualizar(s);
                if (opcion != 0) {
                    String fila = this.id.getText();
                    servicios.Opciones.listar("");
                    servicio.seleccionaFila(fila);
                ...
                s.setIdServicio(0);
                s.setNombre(this.nombre.getText());
                s.setIdServicio(seleccionCategoria());
               
                int opcion = servicios.Opciones.registrar(s);
                if (opcion != 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalServicio.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalServicio dialog = new ModalServicio(new javax.swing.JFrame(), true);
