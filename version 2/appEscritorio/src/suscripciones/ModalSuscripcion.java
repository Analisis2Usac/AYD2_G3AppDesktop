 ...
 * @author Rojeru San
 */
public class ModalSuscripcion extends javax.swing.JDialog {
     ...
     */
    public ModalSuscripcion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtfinicio = new app.bolivia.swing.JCTextField();
        jLabel9 = new javax.swing.JLabel();
        txtffinal = new app.bolivia.swing.JCTextField();
        jLabel10 = new javax.swing.JLabel();
        txtls = new app.bolivia.swing.JCTextField();
        ...
        tipoEmpresa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "EMPRESA" }));
        tipoEmpresa.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jPanel4.add(tipoEmpresa, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 270, 230, 30));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/usuarios/icono-usuario.png"))); // NOI18N
        jPanel4.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 250, 60, 60));

        txttotal.setBorder(null);
        txttotal.setForeground(new java.awt.Color(58, 159, 171));
        txttotal.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txttotal.setPlaceholder("TOTAL");
        jPanel4.add(txttotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 210, 240, 30));
        ...
        txtfinicio.setForeground(new java.awt.Color(58, 159, 171));
        txtfinicio.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtfinicio.setPlaceholder("FECHA INICIO");
        jPanel4.add(txtfinicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 240, 30));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/login/campo-usuario.png"))); // NOI18N
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, -1, -1));

        txtffinal.setBorder(null);
        txtffinal.setForeground(new java.awt.Color(58, 159, 171));
        txtffinal.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtffinal.setPlaceholder(" FECHA FIN");
        jPanel4.add(txtffinal, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 240, 30));

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/login/campo-usuario.png"))); // NOI18N
        jPanel4.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 80, -1, -1));

        txtls.setBorder(null);
        txtls.setForeground(new java.awt.Color(58, 159, 171));
        txtls.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtls.setPlaceholder("LIMITE SERVICIO");
        jPanel4.add(txtls, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 240, 30));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/login/campo-usuario.png"))); // NOI18N
        jPanel4.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, -1, -1));
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
         ...
         if (this.txttotal.getText().equals("") ) {
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                suscripciones.Sentencias s = new suscripciones.Sentencias();

               int valSeleccion = selectEmpresa();
                
                if(valSeleccion==0){
                    s.setIdEmpresa(variablesGlobales.variablesEstaticas.id_empresa);
                }else{
                    s.setIdEmpresa(valSeleccion);
                }
                
                s.setTotal(Integer.parseInt(txttotal.getText()));
                s.setFechaInicio(txtfinicio.getText());
                s.setFechaFin(txtffinal.getText());
                s.setLimite(Integer.parseInt(txtls.getText()));
                s.setSuscripcion(Integer.parseInt(id.getText()));
               
                int opcion = suscripciones.Opciones.actualizar(s);
                if (opcion != 0) {
                    String fila = this.id.getText();
                    suscripciones.Opciones.listar("");
                ...
                int opcion = suscripciones.Opciones.registrar(s);
                if (opcion != 0) {
                    String fila = String.valueOf(suscripciones.Opciones.extraerID());
                    limpiarCampos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalSuscripcion.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalSuscripcion dialog = new ModalSuscripcion(new javax.swing.JFrame(), true);
    ...
    public static app.bolivia.swing.JCTextField txtffinal;
    public static app.bolivia.swing.JCTextField txtfinicio;
    public static app.bolivia.swing.JCTextField txtls;
