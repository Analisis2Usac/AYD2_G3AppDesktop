 ...
 * @author Rojeru San
 */
public class ModalVideo extends javax.swing.JDialog {
     ...
     */
    public ModalVideo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        }
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        int seleccion =  seleccionEmpleado();
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                videos.Sentencias s = new Sentencias();

                s.setidVideo(Integer.parseInt(this.id.getText()));
                s.setruta(this.ruta.getText());
               
                if(seleccion == 0){
                    s.setidEmpleado(variablesGlobales.variablesEstaticas.id_empleado);
                    
                }else {
                    s.setidEmpleado(seleccion);
                    
                }
               
                int opcion = videos.Opciones.actualizar(s);
                if (opcion != 0) {
                    String fila = this.id.getText();
                    videos.Opciones.listar("");
                    VVideo.seleccionaFila(fila);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalVideo.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalVideo dialog = new ModalVideo(new javax.swing.JFrame(), true);
